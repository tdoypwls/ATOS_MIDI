...
isNewModelTrain = bool(psd_df['icftp_isNewModelTrain'].values[0])
isDFPC_DataSet = bool(psd_df['icftp_isDFPC_DataSet'].values[0])
isDFPC_users =  bool(psd_df['icftp_isDFPC_users'].values[0])
isDFPC_composer = bool(psd_df['icftp_isDFPC_composer'].values[0])
isDFPC_genre = bool(psd_df['icftp_isDFPC_genre'].values[0])
isDFPC_mood = bool(psd_df['icftp_isDFPC_mood'].values[0])
isDFPC_rhythm = bool(psd_df['icftp_isDFPC_rhythm'].values[0])
isDFPC_tag = bool(psd_df['icftp_isDFPC_tag'].values[0])
isDFPC_tempo = bool(psd_df['icftp_isDFPC_tempo'].values[0])
...
if isNewModelTrain:
    ...
    model.save(path_model + 'img_cnn_for_tempo_model.h5')

else:
    # 모델 불러오기 (새롭게 학습 시 생략 가능)
    model = load_model(path_model + 'img_cnn_for_tempo_model.h5')
...
if isDFPC_DataSet:
    ...
    save_pkl = composer_cnn_df(dir_test_str).to_pickle(pkl_path + 'DFPC_DataSet_tempo_df.pkl')
    show_df = pd.read_pickle(pkl_path + 'DFPC_DataSet_tempo_df.pkl')
    print(show_df)

if isDFPC_users:
    dir_test_str = './DFPC_users'
    save_pkl = composer_cnn_df(dir_test_str).to_pickle(pkl_path + 'DFPC_users_tempo_df.pkl')
    show_df = pd.read_pickle(pkl_path + 'DFPC_users_tempo_df.pkl')
    print(show_df)

if isDFPC_composer:
    dir_test_str = './DFPC_composer'
    save_pkl = composer_cnn_df(dir_test_str).to_pickle(pkl_path + 'DFPC_composer_tempo_df.pkl')
    show_df = pd.read_pickle(pkl_path + 'DFPC_composer_tempo_df.pkl')
    print(show_df)

if isDFPC_genre:
    dir_test_str = './DFPC_genre'
    save_pkl = composer_cnn_df(dir_test_str).to_pickle(pkl_path + 'DFPC_genre_tempo_df.pkl')
    show_df = pd.read_pickle(pkl_path + 'DFPC_genre_tempo_df.pkl')
    print(show_df)

if isDFPC_mood:
    dir_test_str = './DFPC_mood'
    save_pkl = composer_cnn_df(dir_test_str).to_pickle(pkl_path + 'DFPC_mood_tempo_df.pkl')
    show_df = pd.read_pickle(pkl_path + 'DFPC_mood_tempo_df.pkl')
    print(show_df)

if isDFPC_rhythm:
    dir_test_str = './DFPC_rhythm'
    save_pkl = composer_cnn_df(dir_test_str).to_pickle(pkl_path + 'DFPC_rhythm_tempo_df.pkl')
    show_df = pd.read_pickle(pkl_path + 'DFPC_rhythm_tempo_df.pkl')
    print(show_df)

if isDFPC_tag:
    dir_test_str = './DFPC_tag'
    save_pkl = composer_cnn_df(dir_test_str).to_pickle(pkl_path + 'DFPC_tag_tempo_df.pkl')
    show_df = pd.read_pickle(pkl_path + 'DFPC_tag_tempo_df.pkl')
    print(show_df)

if isDFPC_tempo:
    dir_test_str = './DFPC_tempo'
    save_pkl = composer_cnn_df(dir_test_str).to_pickle(pkl_path + 'DFPC_tempo_tempo_df.pkl')
    show_df = pd.read_pickle(pkl_path + 'DFPC_tempo_tempo_df.pkl')
    print(show_df)
